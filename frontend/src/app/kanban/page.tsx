// Target file: frontend/src/app/kanban/page.tsx
"use client";
  ...
  const TaskCard = ({ task }: { task: Task }) => {
    ...
    return (
      <div
        ...
        className={`rounded-3xl border bg-white/75 backdrop-blur-xl p-4 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:scale-[1.01] hover:shadow-2xl shadow-blue-500/15 ${
      ...
      >
        ...
        <div className="space-y-2 text-xs text-slate-500">
          <div className="rounded-2xl border border-slate-100 bg-white/70 p-2">
      ...
      <div
        ...
        className={`min-h-[560px] rounded-3xl border p-4 shadow-sm transition-all duration-300 ${
          ...
          dragOverColumn === column.id
            ? "scale-[1.01] border-indigo-300 bg-white/75 shadow-2xl ring-4 ring-indigo-100"
            : ""
        }`}
      >
  ...
  if (loading) {
    return (
      <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-sky-100 via-indigo-100 to-cyan-100">
        <div className="rounded-3xl border border-slate-100 bg-white/75 px-8 py-5 shadow-xl shadow-blue-500/10 backdrop-blur">
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-sky-100 via-indigo-100 to-cyan-100 p-6">
      <div className="mx-auto max-w-[1800px]">
        <div className="mb-6 rounded-3xl border border-slate-100 bg-white/75 p-6 shadow-2xl shadow-blue-500/15 backdrop-blur">
          <div className="flex flex-col gap-5 lg:flex-row lg:items-start lg:justify-between">
            <div>
              <div className="mb-3 inline-flex items-center gap-2 rounded-full border border-slate-200 bg-white/70 px-3 py-1 text-xs font-bold text-slate-700">
                  ...
                  <div className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                    ...
                    <div className="flex shrink-0 flex-wrap gap-2">
                      ...
                      <button
                        ...
                        className="rounded-2xl border border-slate-100 bg-white px-4 py-2 text-sm font-bold text-slate-600 shadow-sm hover:bg-white/70"
                      >
                        Show All
                      </button>
                    </div>
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 md:grid-cols-5">
          <div className="rounded-3xl border-l-8 border-indigo-300 bg-white/75 backdrop-blur-xl p-5 shadow-xl shadow-blue-500/10 shadow-blue-500/10">
            <p className="text-sm text-slate-500">Visible Tasks</p>
            <p className="text-3xl font-black text-indigo-600">{totalTasks}</p>
          </div>

          <div className="rounded-3xl border-l-8 border-purple-300 bg-white/75 backdrop-blur-xl p-5 shadow-xl shadow-blue-500/10 shadow-blue-500/10">
          ...
          <div className="rounded-3xl border-l-8 border-emerald-300 bg-white/75 backdrop-blur-xl p-5 shadow-xl shadow-blue-500/10 shadow-blue-500/10">
            <p className="text-sm text-slate-500">Done</p>
            <p className="text-3xl font-black text-emerald-600">{doneCount}</p>
          </div>

          <div className="rounded-3xl border-l-8 border-rose-300 bg-white/75 backdrop-blur-xl p-5 shadow-xl shadow-blue-500/10 shadow-blue-500/10">
            <p className="text-sm text-slate-500">Overdue</p>
            <p className="text-3xl font-black text-rose-600">{overdueCount}</p>
          </div>

          <div className="rounded-3xl border-l-8 border-cyan-300 bg-white/75 backdrop-blur-xl p-5 shadow-xl shadow-blue-500/10 shadow-blue-500/10">
        ...
        <div className="mb-6 rounded-3xl border border-slate-100 bg-white/75 p-5 shadow-xl shadow-blue-500/10">
          <div className="grid grid-cols-1 gap-3 lg:grid-cols-5">
            <input
              className="rounded-2xl border border-slate-200 bg-white/70 p-3 text-sm outline-none focus:ring-2 focus:ring-indigo-300"
        ...
        {selectedTask && (
          <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/40 p-4 backdrop-blur-sm">
            <div className="w-full max-w-3xl rounded-3xl border border-slate-100 bg-white/75 backdrop-blur-xl p-6 shadow-2xl">
              <div className="mb-5 flex items-start justify-between gap-4">
                ...
                <button
                  ...
                  className="rounded-2xl bg-white/60 px-4 py-2 text-sm font-black text-slate-600 hover:bg-slate-200"
                >
                  Close
                </button>
              </div>
